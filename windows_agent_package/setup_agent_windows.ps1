...
.DESCRIPTION
    This script now configures the agent to run every 2 minutes.
#>
param()
...
# *** FIX: Changed repetition interval from 15 minutes to 2 minutes ***
...
Write-Host "Registering scheduled task '$TaskName' to run every 2 minutes..."
try {
